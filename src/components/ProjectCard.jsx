    ...
    return (
        <>
            <div className="projectCard col-md-5" style={{ padding: '2%' }}>
                ...
                <a onClick={() => props.details(props.id, props.name, props.keywords, props.process, props.modal, props.proto)} data-toggle="modal" data-target={props.modal}><img src={props.imgUrl} className="cardImg latest d-block w-100" alt="" style={{ backgroundColor: "#ebfcf1", cursor: "pointer" }} onClick={() => props.details(props.id,props.name, props.keywords, props.process, props.modal, props.proto)}/>
                    <div className="middle">   
                    </div>
                </a>
                </div>
                <div style={{ height: '245px', overflow: 'hidden', paddingLeft: '1%', paddingRight: '1%' }}>
                    <a className="cardh3a" onClick={() => props.details(props.id, props.name, props.keywords, props.process, props.modal, props.proto)} data-toggle="modal" data-target={props.modal}>
