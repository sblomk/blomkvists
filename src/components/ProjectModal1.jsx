                ...
                <div className="modal-dialog modal-lg">
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            ...
                            One of its strengths for example was its lack of needed interaction during use. </p>
                            ...
                            identifying more needs and motivation to use Spotify Running. Now we also had information and user insight to put together a mood board. 
                             </p>
