                ...
                <div className="modal-dialog modal-lg">
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            ...
                            To identify why people chose the bicycle as their mode of transportation and potential pain points, interviews with bicyclists was held. 
                            ...
                            From the results of the user research we developed personas which we the used in a series of brainstorming exercises, 
                            ...
                            <p> <h6>Goals &amp; Visions </h6><br></br>
                            We set our goal to aiding bicyclists in reaching their destination as efficiently as possible. The vision being:
                            ...
                            <p> <h6>Prototyping </h6><br></br>
                            Two digital prototypes, one for the device (the actual Velo) and one for the mobile app, was developed. First we created wireframes 
