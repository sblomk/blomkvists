        ...
        return (
                ...
                <div className="modal-dialog modal-lg">
                    <div className="modal-content">
                        ...
                        <p> <h6>Wireframing </h6><br></br>To get a better grip on technical requirements, necessary functionality,  and how to 
                        ...
                        <p> <h6>Web Development </h6><br></br>Two websites was developed using React.js, Bootstrap, and Chart.js. One with only visual 
